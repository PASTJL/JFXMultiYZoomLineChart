 ...
 */
public class SimpleLineChartsMultiYAxisMainXDate extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		chart.addSeries(prepareInverseSeries("Pivot5", (x) -> ((double) (x + 100) * (x - 200)), 0L), Color.RED, "Ko/s");
