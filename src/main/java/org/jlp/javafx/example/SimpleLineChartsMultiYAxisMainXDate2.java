 ...
 */
public class SimpleLineChartsMultiYAxisMainXDate2 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		URL stylesheet = SimpleLineChartsMultiYAxisMainXDate2.class.getResource("/org/jlp/javafx/style.css");
		if (null == stylesheet) {
		...
		primaryStage.show();
		System.out.println("apres lancement, trying to delete  Pivot3");
		...
		alert.setContentText("trying to delete Pivot5: ");
		alert.showAndWait();
		chart.delSerie("Pivot5");

		alert.setContentText("trying to add Pivot5: ");
		alert.showAndWait();
		chart.addSeries(prepareInverseSeries("Pivot5", (x) -> ((double) (x + 100) * (x - 200)), 0L), Color.BLUE,
				"toDestroy");
